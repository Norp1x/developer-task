package com.search.project.kafka.producer.config;

import com.search.project.kafka.config.data.KafkaConfigData;
import com.search.project.kafka.config.data.KafkaProducerConfigData;
 ...
 */
@Configuration
@ComponentScan(basePackages = "com.search.project.kafka.config.data")
